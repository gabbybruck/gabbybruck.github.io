...
export class ContentService {
  pages: any = {
    ...
    'illustration': {title: 'ILLUSTRATIONS', content: 'A collection of some of my recent illustrations.', 
    projectsL:[
    ...
    projectsL:[
      ...
      {title: 'Library Database', subtitle: 'Database Design Final Project', cover: 'assets/library.png',details: 'Database Design Final Project', detailPhotos: ['assets/library.png']},
    ], projectsR:[
